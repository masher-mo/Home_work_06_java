...
public class task_001 {
   ...
   public static Map<String, String> selectCriteria() {
      ...
      while (true) {
         System.out.println("Вы хотите выбрать параметры? Если да- то введите 'y', если нет- введите 'n'");
   ...
   public static void sort(Map<String, String> criterias, Set<Notebook> notebooks) {
      ...
      if (temp.isEmpty()) {
         System.out.println("По введенным параметрам ничего нет!");
      } else {
         System.out.println("Есть другие варианты, например: \n" + temp.toString());
      }
